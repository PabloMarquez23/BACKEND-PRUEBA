...
a persistence unit "EvaluacionMarquezPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EvaluacionMarquez/pom.xml":
...
artifact ("EvaluacionMarquez.war") is already built. You can build
